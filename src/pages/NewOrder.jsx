    ...
    <div className="max-w-5xl mx-auto px-6 pt-8 pb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="product-card" onClick={() => alert('Você seria redirecionado pro catálogo do artista')}>
          <div className="w-14 h-14 rounded-2xl avatar-4 flex items-center justify-center mb-4" style={{ color: '#0c0230' }}><MusicNote size={26} /></div>
        ...
        <div className="product-card featured" onClick={() => navigate('/encomendar/personalizada')}>
          ...
          <ul className="space-y-2 mb-5">
            <Feat color="#00c5e4">100% exclusiva pra você</Feat>
            <Feat color="#00c5e4"><strong className="text-white">Até 3 revisões gratuitas</strong></Feat>
            <Feat color="#00c5e4">Perfeita pra homenagem, casamento</Feat>
          </ul>
          <p className="text-slate-500 text-xs mb-3">A partir de</p>
        ...
        <div className="product-card" onClick={() => alert('Formulário de jingle instrumental')}>
          <div className="w-14 h-14 rounded-2xl avatar-6 flex items-center justify-center mb-4" style={{ color: '#0c0230' }}><Mic size={26} /></div>
          <div className="flex items-center gap-2 mb-2">
